#line 1 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
#include <Arduino.h>
#include <Wire.h>
#include <SPI.h>
#include <LoRa.h>
...
// Utility
// =========================
#line 157 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
const char * statusToString(FireStatus status);
#line 169 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void debugPrintln(const String &msg);
#line 175 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void disableUnusedRadios();
#line 180 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void powerSensors(bool on);
#line 190 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
int median3(int a, int b, int c);
#line 196 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
int readSharpOnce();
#line 208 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
int readSmokeMedian();
#line 217 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isShtReadingSane(float t, float h);
#line 224 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool beginSht31();
#line 237 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void initSensors();
#line 261 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool initLoRa();
#line 284 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool ensureLoRaReady();
#line 293 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
SensorData readSensors();
#line 325 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void updateDerivedSensorHealth(SensorData &data);
#line 359 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool hasSensorFault(const SensorData &data);
#line 365 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isBootAbnormalReading(const SensorData &data);
#line 373 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isStoredBaselineSane(float airTemp, float humidity, int smokeRaw);
#line 380 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool loadBaselineFromNvs();
#line 417 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void saveBaselineToNvs();
#line 434 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool clearLearnedBaseline();
#line 460 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
String baselineRecalibrationBlockReason();
#line 473 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool updateBaselineWarmup(const SensorData &data);
#line 498 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
float getElapsedMinutesForDelta(unsigned long nowMs);
#line 512 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
DeltaData calculateDelta(const SensorData &current, const SensorData &previous, bool hasPrev, unsigned long nowMs);
#line 547 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
EvidenceFlags getEvidenceFlags(const SensorData &data, const DeltaData &delta);
#line 608 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
int calculateConfidence(const SensorData &data, const DeltaData &delta, const EvidenceFlags &e);
#line 641 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
FireStatus evaluateFireStatusRaw(const SensorData &data, const EvidenceFlags &e, int confidence);
#line 673 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
int statusSeverity(FireStatus status);
#line 685 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isWeakEnvironmentalWatch(FireStatus rawStatus, const EvidenceFlags &e, int confidence);
#line 693 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
FireStatus applyWeakWatchDebounce(FireStatus rawStatus, const EvidenceFlags &e, int confidence);
#line 715 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
FireStatus applyCriticalDebounce(FireStatus rawStatus);
#line 727 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
FireStatus applyStateLatch(FireStatus rawStatus, int confidence);
#line 761 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
FireStatus evaluateFireStatus(const SensorData &data, const EvidenceFlags &e, int confidence);
#line 768 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void updateBaselineAfterDecision(const SensorData &data, const DeltaData &delta, const EvidenceFlags &e, FireStatus status);
#line 789 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
String makeEventId();
#line 794 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void addFloatOrNull(JsonDocument &doc, const char *key, float value);
#line 799 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
String sensorHealthString(const SensorData &data);
#line 805 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
uint32_t plannedReportIntervalSeconds(FireStatus status);
#line 819 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
...
#line 922 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool sendSensorPacketWithAck(const String &payload);
#line 941 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isGpsCoordinateValid(double latitude, double longitude);
#line 949 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void powerGps(bool on);
#line 957 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool loadGpsLocationFromNvs(GpsLocation &fix);
#line 983 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool loadGpsManualModeFromNvs();
#line 995 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void saveGpsLocationToNvs(const GpsLocation &fix);
#line 1011 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void saveGpsManualModeToNvs();
#line 1020 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void clearGpsLocationFromNvs();
#line 1028 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
String buildGpsPacket(const GpsLocation &fix, bool gpsFix, const char *errorCode);
#line 1054 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void sendGpsLocationPackets(const GpsLocation &fix);
#line 1061 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void sendGpsFailedPacket(const GpsLocation &partialFix);
#line 1066 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void resetGpsLocation(GpsLocation &fix);
#line 1074 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void stopGpsAcquisition();
#line 1079 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void stopGpsAndUseManualLocation();
#line 1094 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void startGpsAcquisition();
#line 1111 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void startGpsReacquisition();
#line 1127 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void sendPendingGpsReports();
#line 1139 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void serviceOneShotGps();
#line 1218 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void startOneShotGpsIfNeeded();
#line 1256 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void accountGpsRetryBeforeSleep(uint64_t sleepSec);
#line 1265 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isOneShotGpsActive();
#line 1272 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void loadLastHandledCommandId();
#line 1278 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void saveLastHandledCommandId(const String &commandId);
#line 1285 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void sendCommandAckPacket(const String &commandId, bool accepted, const String &reason);
#line 1302 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
String handleGatewayCommand(const String &payload);
#line 1343 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
bool isUplinkAck(const String &payload, uint32_t expectedSeq);
#line 1387 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void delayWithBackgroundTasks(unsigned long durationMs);
#line 1399 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void printSensorDebug(const SensorData &data, const DeltaData &delta, const EvidenceFlags &e, FireStatus status, int confidence);
#line 1436 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
uint64_t sleepSecondsForStatus(FireStatus status);
#line 1448 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void storeExpectedNextInterval(FireStatus status);
#line 1458 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void enterDeepSleepForSeconds(uint64_t sleepSec);
#line 1470 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void enterDeepSleepByStatus(FireStatus status);
#line 1479 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void serviceGpsUntilNextMeasurementOrSleep(FireStatus status);
#line 1505 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
...
#line 1522 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void runOneMeasurementCycle();
#line 1575 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void resetRuntimeStateForTestMode();
#line 1609 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void setup();
#line 1639 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
void loop();
#line 157 "C:\\wildfire_lora\\sensor_node\\sensor_node.ino"
const char* statusToString(FireStatus status) {
  switch (status) {
