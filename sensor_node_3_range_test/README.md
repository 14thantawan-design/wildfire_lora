...
เฟิร์มแวร์ตรวจหา OLED address `0x3C` อัตโนมัติทั้งชุดขา TTGO LoRa32 V1
(SDA 4/SCL 15) และ V2 (SDA 21/SCL 22) โดยไม่แตะ GPIO16 เนื่องจากบอร์ด
ESP32-PICO-D4 ชุดที่ทดสอบบน COM7 รีเซ็ตด้วย Watchdog เมื่อใช้ขานี้ ไลบรารีจะไม่
เริ่ม I2C ซ้ำหลังเลือกชุดขาแล้ว
