...
| `CRITICAL` | 20 วินาที | ESP32 และเซนเซอร์ทำงานต่อเนื่อง; ส่งซ้ำฉุกเฉิน 3 ชุดในรอบแรก |
...
เมื่อเป็น `CRITICAL` Node จะรอ ACK จาก Gateway หลังส่งแต่ละครั้ง ถ้ายังไม่ได้รับจะลองซ้ำ
ได้สูงสุด 3 ครั้ง แล้วส่งรอบถัดไปอีกครั้งใน 20 วินาที ส่วนสถานะปกติไม่ใช้ ACK
จึงไม่เพิ่มการใช้แบตโดยไม่จำเป็น
