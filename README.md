...
ระบบใช้สถานะ `NORMAL`, `WATCH`, `WARNING` ตามเกณฑ์ที่กำหนดไว้ในโค้ด
...
Sharp GP2Y1014AU0F อ่าน ADC 12 บิตสามครั้งและใช้ค่ามัธยฐานเพื่อลด spike โดยไม่แปลงเป็น µg/m³:

```text
Particle_ADC = median(ADC1, ADC2, ADC3)
```
...
```json
{"t":"s","id":"NODE01","q":12,"sid":1234,"ri":20,"st":"WARNING","at":30,"h":30,"adc":1200,"sh":"OK"}
```
