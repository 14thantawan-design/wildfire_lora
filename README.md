...
บอร์ด Sensor Node ได้รับการยืนยันจากตัวบอร์ดว่าเป็น **LILYGO T3 V1.6.1 (LoRa32 V2.1.6)** จึงตั้ง `BATTERY_ADC_PIN` เป็น `GPIO39` (`VN`, ADC1) แล้ว ขานี้เป็นอินพุตอย่างเดียวและไม่ชนกับ LoRa, GPS, Sharp, SHT31, OLED หรือขาควบคุมไฟที่ใช้อยู่ใน Sensor Node

### วิธีคาลิเบรตกับมัลติมิเตอร์

1. ต่อจุดกึ่งกลางของวงจรแบ่งแรงดันเข้าขา `GPIO39 / VN` และต่อ GND ของแบตกับ GND ของ TTGO ให้ร่วมกัน
